...
//
// MAINTENANCE NOTE: the filter logic below is a PHP port of the shared
// lib/eventMatch.js (which is the canonical source, used by both app.js
// in the browser and scripts/send-notifications.js in Node). PHP can't
// share JS code directly so this is necessarily a separate copy. When
// you change feed-pref categories, sport mappings, tag handling, etc.,
// in lib/eventMatch.js — re-port here. Calendar subscribers will silently
// get the old behavior otherwise.
// Last sync with lib/eventMatch.js: 2026-05-11.
